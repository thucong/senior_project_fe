...
class EditProfile extends Component{
    ...
    onSubmitProfile = () => {
        if (this.state.name === "") {
            ...
            axios.put(API_URL + "update-profile/"+ cookies.get('id_user'), {
            ...
            <div>
                ...
                <div className="mt-2">
                    <div className="form-group">
                       Full name (*):
                        <input type="text" className="form-control mt-3" placeholder="Full name" value={this.state.name} onChange={this.onChangeName} onBlur={this.onBlurName} />
                    </div>
                    {this.state.name_blank === true ? <p className="text-danger mt-1 mb-3">(*) Full name cannot be left blank !</p> : ""}
                    <div className="form-group">
                        Gender:
                    ...
                    <div className="form-group">
                        Phone:
                        <div><input type="text" value={this.state.phone} className="form-control mt-3" onChange={this.onChangePhone}/></div>
                    </div>
                    <div className="form-group">
                        Email:
                        <div><input type="text" value={this.state.email} className="form-control mt-3" onChange={this.onChangeEmail}/></div>
                    </div>
                    <div className="form-group">
                        Address:
                        <div><input type="text" value={this.state.address} className="form-control mt-3" onChange={this.onChangeAddress}/></div>
                    </div>
                    <div className="form-group">
                        Province or City:
                    ...
                    {this.state.success?<div className="text-success">Save successfully</div>:""}
                    <button type="submit" className="btn btn-success center mt-4" onClick={this.onSubmitProfile}>Save</button>
                </div>
            </div>
        )
    }
